...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?php echo base_url()?>">iTourGuide | Traveller | Search</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
          <a class="nav-link" href="<?php echo base_url()?>traveller/basicinfo">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Link">
          <a class="nav-link" href="<?php echo base_url()?>traveller/searchform">
          ...
          <div class="w3-row w3-center">   
            ...
            <div class="w3-col l4">
              <div class="w3-row w3-animate-zoom">
                <div class="w3-col l7 w3-padding w3-center">
                    <img src="<?php echo base_url()?>img/<?php echo $s['img']?>" style="width:170px;height: 100px"  class="w3-card-2 w3-border w3-border-white">                 
                </div>
                 <div class="w3-col l5" style="text-align:justify;font-size: 10px">                              
                   <span><b><?php echo $s['pname']?></b></span>  <br>
                   <span><b>Division:</b> <?php echo $s['continent']?></span>   <br>           
                   <span><b>District:</b> <?php echo $s['country']?></span>  <br>            
                   <a href="<?php echo "show/".$s['pid']?>" style="text-decoration: none;" class="w3-text-blue"> <b>Learn more ...</b></a>              
                </div>
              </div>              
            </div>
            <?php }?>            
