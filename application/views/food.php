 	 ...
 	 <div id="hotelReg" class="w3-modal" style="z-index: 10000">
 	  ...
 	  <div class="w3-row w3-center w3-padding-16">
 	  	...
 	  	<div style="width: 1000px; margin: 0px auto">
 	  		<h2 class="w3-center w3-text-green" style="width:250px;margin: 0px auto"><i class="fa fa-cutlery"></i> FOOD</h2>
 	  		<br><br>
 	  		...
 	  		<img src="img/22.jpg" style="min-width: 90%" class="w3-margin-top w3-margin-bottom w3-card-4 w3-border w3-border-black">
