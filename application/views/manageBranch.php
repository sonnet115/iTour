...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?php echo base_url()?>">iTourGuide | Manage Hotel Branch</a>
    ...
    <div class="container-fluid">      
      ...
      <div class="card mb-3 w3-card-2">
        <div class="card-header w3-grey">
          <i class="fa fa-search"></i> Manage Your Hotel</div>
        <div class="card-body">
          <div class="w3-row w3-center" style="max-width:margin:0 auto">            
              <?php foreach ($branch as $p) {?>                     
                <div class="w3-col l3 w3-padding w3-center">
                    <img src="<?php echo base_url().'img'.'/'.$p['img']?>" style="height: 150px;max-width: 100%">
                    <br>
                    <br>
                    <a href="<?php echo $p['website']?>" class="w3-button w3-teal">Visit Website</a>                                                  
                </div>                         
                <?php }?>         
          </div>
        </div>        
