...
<div class="">
  <nav class="navbar navbar-inverse w3-animate-opacity">
    <div class="navbar-header">
		...
		<a class="navbar-brand" href="#" style="margin-top:10px">iTour Guide</a>
	</div>
 ...
 -->
	...
	<div class="w3-row w3-green w3-center" >
		<h3 class="w3-margin-left w3-animate-top"><i class="fa fa-ellipsis-v"></i> Places You Should Visit</h3>
		<br>
		<?php foreach ($top as $t) {?>	
		<div class="w3-col l3 foodImg">
			<div class="w3-padding w3-light-grey">
				<div class="w3-card-2 w3-padding-16  w3-white w3-animate-zoom">
					<img src="<?php echo base_url().'img'.'/'.$t['img']?>" style="height: 150px" class="w3-card-4">
					<br>
					<br>
					<p><b><?php echo $t['name']?></b></p>					
					<a href="show/<?php echo $t['pid']?>" style="text-decoration: none;" class="w3-button w3-green">Learn more ...</a>
				</div>				
			</div>		
		</div>
		<?php } ?>
	...
	<div class="w3-row">	
		<h3 class="w3-margin-left w3-center w3-animate-zoom"><i class="fa fa-bank"></i> BANGLADESH AT A GLANCE</h3>
		<hr>
		<div class="w3-col l4 w3-padding" >
			<img src="img/24.jpg" style="max-width: 100%" class="w3-card-4">
			<a href="hill" class="w3-button w3-red w3-card-4" style="margin-top: 5px;width: 100%">
				<span class="w3-left">Click for more info</span>		
				<span class="w3-right">Hill Tracks</span>		
			</a>
		</div>

		<div class="w3-col l4 w3-padding" >
			<img src="img/22.jpg" style="max-width: 100%" class="w3-card-4">
			<a href="food" class="w3-button w3-red w3-card-4" style="margin-top: 5px;width: 100%">
				<span class="w3-left">Click for more info</span>		
				<span class="w3-right">Foods</span>		
			</a>
		</div>

		<div class="w3-col l4 w3-padding" >
			<img src="img/23.jpg" style="max-width: 100%" class="w3-card-4">
			<a href="fest" class="w3-button w3-red w3-card-4" style="margin-top: 5px;width: 100%">
				<span class="w3-left">Click for more info</span>		
				<span class="w3-right">Festivals</span>		
			</a>
		</div>

		<div class="w3-col l4 w3-padding" >
			<img src="img/21.jpg" style="max-width: 100%" class="w3-card-4">
			<a href="thrill" class="w3-button w3-red w3-card-4" style="margin-top: 5px;width: 100%">
				<span class="w3-left">Click for more info</span>		
				<span class="w3-right">Thrill</span>		
			</a>
		</div>

		<div class="w3-col l4 w3-padding" >
			<img src="img/25.jpg" style="max-width: 100%" class="w3-card-4">
			<a href="forest" class="w3-button w3-red w3-card-4" style="margin-top: 5px;width: 100%">
				<span class="w3-left">Click for more info</span>		
				<span class="w3-right">Forests</span>		
			</a>
		</div>

		<div class="w3-col l4 w3-padding" >
			<img src="img/26.jpg" style="max-width: 100%" class="w3-card-4"	>
			<a href="archaeology" class="w3-button w3-red w3-card-4" style="margin-top: 5px;width: 100%">
				<span class="w3-left">Click for more info</span>		
				<span class="w3-right">Archaeology</span>		
			</a>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function validate(e) {
			...
			if(wage.value == "Thanks"){
				...
				var t1 = document.createTextNode("Sorry Can't get you.");
			}
